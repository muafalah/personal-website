...
export default function CareerCard({
  ...
  return (
    <Card className="relative flex items-center gap-5 py-4 px-6 border border-neutral-300 dark:border-neutral-800 dark:bg-neutral-800">
      <div className="absolute top-0 left-0 bg-neutral-300 text-emerald-950 text-[13px] font-medium py-1 px-2 rounded-br-xl rounded-tl-xl z-[2]">
        {type}
      </div>
